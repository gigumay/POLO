...
from ultralytics.utils.loss import v8ClassificationLoss, v8DetectionLoss, v8LocalizationLoss, v8OBBLoss, v8PoseLoss, v8SegmentationLoss
...
class LocalizationModel(BaseModel):
    ...
    def _predict_augment(self, x):
        raise(NotImplementedError, "Augmented prediction not implemented for localization")
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in (Detect, WorldDetect, Locate, Segment, Pose, OBB, ImagePoolingAttn):
